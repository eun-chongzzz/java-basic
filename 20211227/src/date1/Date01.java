...
public class Date01 {
	...
	public static void main(String[] args) {
		...
		// now 변수에 들어있던 출력양식을 2021년 12월 27일 aa시 bb분 cc초로 변경해서 콘솔에 찍어주세요.
		SimpleDateFormat dsf = new SimpleDateFormat("yyyy년 MM월 dd일 hh시 mm분 ss초 기준시 : z");
		String strNow3 = dsf.format(now);
