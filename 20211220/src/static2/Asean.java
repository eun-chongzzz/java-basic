...
public class Asean {
	...
	// public으로 설정하면 바로 System.out.prinln();으로 조회가능하고
	...
	// 일반 static 메서드로 발표점수만 조회할 수 있는 showPre()를 만들어주세요.
	public static void showPre() {
		System.out.println("ASEAN조의 발표점수 : " + presentationScore + "점");
	}
	// 일반 메서드로 showAseanInfo()를 생성해주시되 성적 전체를 콘솔에 조회하게 해주세요.
	// 중간고사 : xx점, 기말고사 : yy점 ...
	public void showAseanInfo() {
		System.out.println("조원의 성적");
		System.out.println("출석점수 : " + this.check + ", 중간 : " + 
		this.midTerm + ", 기말 : " + this.finalTerm + ", 발표 : " + presentationScore);
	}
