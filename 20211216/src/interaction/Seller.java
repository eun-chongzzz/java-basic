...
public class Seller {
	// 변수로 int money(매출), int mongo(재고)를 가집니다.
	...
	// sellMongo(int mango) 를 이용해서 망고개수를 입력받으면(dobBattle과 유사)
	// 자신의 this.mango는 갯수만틈 차감하고, this.mango는 망고개수* 가격 만큼 증가
	...
	public void showSeller() {
		...
		System.out.println("현재소지금 : " + this.money + " 현재망고재고 : " + mango);
		System.out.println("-------------------");
	}
